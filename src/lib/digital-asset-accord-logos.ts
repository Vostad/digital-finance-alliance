/**
 * THE DIGITAL FINANCE ALLIANCE NETWORK — the single source of logo truth.
 *
 ...
 * network section and the Financial Rails V2 partner proof), so adding,
 ...
 */
export const DIGITAL_ASSET_ACCORD_LOGOS: string[] = Array.from(
  { length: 80 },
  (_, i) => `/network-logos/${i + 1}.png`,
);

/**
 * THE DIGITAL FINANCE FEATURED SET — 32 of the 80, curated by sector.
 *
 ...
 */
const DIGITAL_FINANCE_FEATURED_INDICES = [
  // banks
  ...
  // exchanges
  52, 26, 25,
  // custody, settlement and digital asset infrastructure
  33, 58, 59, 31, 19, 69, 7,
];

export const DIGITAL_FINANCE_FEATURED_LOGOS: string[] = DIGITAL_FINANCE_FEATURED_INDICES.map(
